...
public class Camera extends SubsystemBase {
  ...
  public Camera(CommandSwerveDrivetrain swerve) {
    ...
    Transform3d robotToCam = new Transform3d(new Translation3d(-0.30, 0, 0.18),
        new Rotation3d(Math.toDegrees(0), Math.toRadians(-33), Math.toRadians(180))); // Cam mounted facing forward, half a meter forward
